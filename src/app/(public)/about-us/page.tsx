    ...
    return (
        <div className=" relative z-10 pt-[12svh] flex flex-col ">
            ...
            <div className="text-2xl h-[47.5svh]  border-b border-koosha-pr flex justify-center items-center px-[13svw] ">
                ...
                <div className=" h-full  flex w-full">
                    <Image src={about} alt="" className="w-auto h-fit" />
                </div>
            </div>
            ...
            <div className=" grid grid-cols-3 gap-20 px-[13svw] py-[5svh]  h-[80svh]">
            ...
            <div className="  py-[20svh] border-b border-koosha-pr flex flex-col justify-center items-center px-[13svw] gap-6 ">
                <p className="text-4xl text-koosha-pr font-black">آکادمی سرمایه‌گذاری ایده‌آل</p>
                <p className="w-[40svw] text-center">
